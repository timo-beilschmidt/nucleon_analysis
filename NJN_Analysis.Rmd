        ...
        for(p_tag in mom_tag){
           ...
           # d[[sprintf("%s_%s_%s", g[1], g[2], p_tag)]] <- plotAndCalc(g[1], g[2], p_tag, test)
            ...
            if(!length(cf_2pt[[p_tot_tag]][[g[1]]])){
                ...
                cf_3pt[[p_tot_tag]][[g[2]]] <- list()

            }
            if(!length(cf_2pt[[p_tot_tag]][[g[1]]][[g[2]]])){
                cf_2pt[[p_tot_tag]][[g[1]]][[g[2]]] <- mul.cf(cf$c2 , factor)
                cf_3pt[[p_tot_tag]][[g[1]]][[g[2]]] <- mul.cf(cf$c3 , factor)

            } else {
                cf_2pt[[p_tot_tag]][[g[1]]][[g[2]]] <- add.cf(cf_2pt[[p_tot_tag]][[g[1]]], cf$c2, b=factor)
                cf_3pt[[p_tot_tag]][[g[1]]][[g[2]]] <- add.cf(cf_2pt[[p_tot_tag]][[g[1]]], cf$c3, b=factor)
